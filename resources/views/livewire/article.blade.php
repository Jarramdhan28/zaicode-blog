        ...
        <div class="bg-gradient-to-r from-cyan-100 to-red-100">
            <div class="hero py-20 md:pt-28 md:pb-24">
                ...
                <p class="text-center mt-4 text-md">
                    Resources on web application development. Whether you're a budding developer or a seasoned professional, our
                    ...
                    @foreach ($article as $data )
                        <div class="max-w-full rounded overflow-hidden shadow-lg">
                            <a wire:navigate href="{{ route('article.page', $data->slug)}}" class="hover:text-slate-700">
                                <img class="w-full object-cover h-60 hover:scale-105 transition duration-150 ease-in-out" src="{{'storage/'.$data->image}}" alt="Sunset in the mountains">
                            </a>
                                <div class="px-6 py-4">
                                    <a wire:navigate href="{{ route('article.page', $data->slug)}}" class="hover:text-slate-700">
